            ...
            <div class="prod_box_big">
                <div class="center_prod_box_big" style="margin-left: -20px;">
                    <div class="product_img_big">
                        <div class="thumbs"><img src="<?= !empty($data->image_name) ? base_url('uploads/img/' . $data->image_name) : 'https://mdbootstrap.com/img/Photos/Others/placeholder-avatar.jpg'; ?>" style="width: 200px;margin-left: 6px;margin-top: 10px;" alt="" border="0" /></div>
                    </div>
