            ...
            <?php else : ?>
                <div class="prod_box">
                    <div class="center_prod_box">
                        ...
                        <div class="product_img"><a href="#"><img class="img_barang_herbal" src="<?= !empty($row->image_name) ? base_url('uploads/img/' . $row->image_name) : 'https://mdbootstrap.com/img/Photos/Others/placeholder-avatar.jpg'; ?>" alt="" border="0" height="215px" style="height: 25px;" /></a></div>
                        <div class="prod_price"><span class="reduce"></span> <span class="price">Rp <?= $row->harga ?></span></div>
                    </div>
                    <div class="prod_details_tab">
                        <!-- <a href="#" class="prod_buy">Add to Cart</a> -->
