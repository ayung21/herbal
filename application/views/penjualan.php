<section class="content" style="height: <?= $height; ?>;">
    <div class="center_content">
        <?php foreach ($data as $row) : ?>
            <?php if(parse_url($row->image_name, PHP_URL_SCHEME) == 'https' || parse_url($row->image_name, PHP_URL_SCHEME) == 'http'){ $image = $row->image_name;}else{ $image = base_url('uploads/img/' . $row->image_name);} ?>
            <?php if (mobile()) : ?>
